...
class PerlinNoise {
    ...
    static inline function lerp(t : Float, a : Float, b : Float) : Float {
        return a + t * (b - a);
    }
    ...
    static var permutation : Array<Int> = [ 151, 160, 137, 91, 90,
    15, 131, 13, 201, 95, 96, 53, 194, 233, 7, 225, 140, 36, 103,
    ...
    static var p : Array<Int> = [for (i in 0...512) permutation[Std.int(i % permutation.length)]];
}